    ...
    <div className="flex items-center justify-center h-screen w-screen bg-gradient-to-r from-indigo-500 to-purple-500 text-white p-4">
      <div className="bg-white text-gray-900 p-8 md:p-16 rounded-2xl shadow-2xl text-center w-full max-w-3xl transform transition-all duration-300 hover:scale-105">
        ...
        <div className="flex justify-center gap-6">
          <button
            onClick={addValue}
            className="px-8 py-4 hover:bg-green-600 text-black text-xl font-bold rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
          >
            + Add
          </button>
          <button
            onClick={removeValue}
            className="px-8 py-4 bg-red-500 hover:bg-red-600 text-black text-xl font-bold rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
          >
            - Remove
          </button>
          ...
          <button
            onClick={resetValue}
            className="px-8 py-4 bg-red-500 hover:bg-red-600 text-black text-xl font-bold rounded-lg shadow-lg transition duration-300 transform hover:scale-105 hover:bg-red-600"
          >
            Reset
          </button>
        </div>
